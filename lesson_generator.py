...
class LessonPlanGenerator:
    ...
    def generate_ai_content(self, lesson_data):
        ...
        # Generate comprehensive structured content
        content = {
    ...
    def _generate_objectives(self, lesson_data):
        """Generate HOT (Higher Order Thinking) objectives"""
    ...
    def _generate_outcomes(self, lesson_data):
        """Generate differentiated outcomes based on DOK levels"""
        topic = lesson_data['topic']
        outcomes = {
    ...
    def _generate_vocabulary(self, lesson_data):
        """Generate subject-specific vocabulary"""
        subject_vocab = {
    ...
    def _generate_starter(self, lesson_data):
        """Generate engaging starter activity"""
        topic = lesson_data['topic']
        return {
    ...
    def _generate_differentiated_tasks(self, lesson_data, task_type):
        """Generate differentiated tasks (cooperative or independent)"""
        topic = lesson_data['topic']
    ...
    def _create_7e_slides(self, prs, lesson_data, ai_content):
        """Create 7E Model slides"""
        stages = [
            ('Elicit', 'What do students already know?'),
            ('Engage', ai_content['starter']['activity']),
            ('Explore', 'Students investigate and discover'),
            ('Explain', ai_content['teaching_component']['method']),
            ('Elaborate', 'Deepen understanding through activities'),
            ('Evaluate', 'Assess learning and understanding'),
            ('Extend', ai_content['world_application'])
        ]
    ...
    def _create_gradual_release_slides(self, prs, lesson_data, ai_content):
        """Create I Do, We Do, You Do slides"""
        stages = [
            ('I Do (Teacher Models)', ai_content['teaching_component']['method']),
            ('We Do (Guided Practice)', 'Work together on examples'),
            ('You Do (Independent Practice)', 'Students practice independently')
        ]
    ...
    def _create_traditional_slides(self, prs, lesson_data, ai_content):
        """Create traditional slides"""
        sections = [
            ('Introduction', ai_content['starter']['activity']),
            ('Main Content', ai_content['teaching_component']['method']),
            ('Practice', 'Students work on differentiated activities'),
            ('Summary', ai_content['plenary']['activity'])
        ]
